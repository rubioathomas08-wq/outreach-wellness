...
const services = [
  ...
  },
  {
    ...
    description:
      "Targeted peptide protocols to support healing, recovery, weight management, and longevity from the cellular level up.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    slug: "iv-therapy",
    description:
      "IV infusions plus B12, lipotropic, and immune injectable boosts — for energy, recovery, and wellness.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    slug: "aesthetics",
    description:
      "Skin rejuvenation, microneedling, and chemical peels — non-injectable treatments for a natural, refreshed glow.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Quick, thorough pre-participation physical exams for student athletes — forms signed same day.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
